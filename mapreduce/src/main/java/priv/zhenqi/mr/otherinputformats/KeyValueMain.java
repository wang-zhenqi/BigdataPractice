...
public class KeyValueMain {
    ...
    private static class KeyValueMapper extends Mapper<Text, Text, Text, LongWritable> {
    ...
    private static class KeyValueReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
        @Override
